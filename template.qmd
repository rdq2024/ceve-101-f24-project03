...
The years that kept are the number of years present in the graph after cleaning: 49 years. This is a sufficient data sample because of the longivity of time. According to the research done, the state of Ceara, Brazil, experienced a drought from 2012 to 2018. My data does contain this period of time; however, based of data the region chosen was not hit by this drought becuase there was no missing data for that time period. Therefore, the data is both sufficient and consistant between all 35 years.

## Understanding the Theoretical Model

Let's explore the model that simulates the rainwater harvesting system.

A limiting assumptions is that the consumption of water begins after the rainy season began, about 150 days into the year, and that the average household consumes about 74.1 liters per day. These assumptions can be accounted forby modifying the equations to introduce an outisde varibles to allow for flexibility in the water usage model (Accounting for randomness), such as margin of error.
